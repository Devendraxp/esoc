        ...
        <main className="p-4 md:p-8 pb-20 md:pb-8">
          ...
          {results && (
            <div className="space-y-4 md:space-y-6">
              ...
              {results.relatedPosts && results.relatedPosts.length > 0 && (
                <Card className={`mb-3 md:mb-4 ${
                  theme === 'dark'
                    ...
                    {results.relatedPosts.map(post => (
                      <li key={post.id} className="text-xs md:text-sm">
                        ...
                        >
                          ...
                          <span className="line-clamp-2">{post.snippet}</span>
                        </Link>
                      </li>
                    ))}
                  </ul>
              ...
              <Card className={`${cardBgClass} border ${cardBorderClass}`}>
                ...
                {results.newsLinks && results.newsLinks.length > 0 ? (
                  <ul className="space-y-3">
                    {results.newsLinks.map((article, index) => (
                      <li key={index} className={`border-b ${dividerClass} last:border-b-0 pb-3 last:pb-0`}>
                        ...
                        <div className={`text-2xs md:text-xs ${tertiaryTextClass} mt-1`}>
                  ...
                  <p className={`${secondaryTextClass} text-sm md:text-base`}>No recent news found for this location.</p>
                )}
              </Card>
            </div>
          )}
