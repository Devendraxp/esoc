...
export default function ReportCommentModal({ isOpen, onClose, postId, commentId, commentContent }) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">
              Please provide details about why you're reporting this comment:
            </label>
            <textarea
              value={details}
              onChange={(e) => setDetails(e.target.value)}
              className="w-full p-2 border rounded-md min-h-[100px] bg-white dark:bg-gray-700 text-black dark:text-white"
              placeholder="Please explain why this comment should be reported..."
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              disabled={isSubmitting}
            >
              {isSubmitting ? 'Submitting...' : 'Report Comment'}
            </button>
          </div>
        </form>
      </div>
